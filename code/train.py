...
# Data parameters
data_folder = '/home/yiming_hao/Projects/ImageCaptioning/2019.2.16/my-preprocessed-data2.7/'  # folder with data files saved by create_input_files.py
...
ratio = int(argv[1])
print('ratio: ', ratio)
smaplefile = "./selection/" + str(ratio) + ".npy"
samplearray = np.load(smaplefile)
print(smaplefile)
samples = torch.utils.data.sampler.SubsetRandomSampler(samplearray)
...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        CaptionDataset(data_folder, data_name, 'TRAIN'), sampler=samples,
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if epochs_since_improvement == 20:
            save_checkpoint(data_name, epoch, epochs_since_improvement, decoder,decoder_optimizer, recent_bleu4, True, ratio)
            break
        ...
        # Save checkpoint
        save_checkpoint(data_name, epoch, epochs_since_improvement, decoder,decoder_optimizer, recent_bleu4, is_best, ratio)
